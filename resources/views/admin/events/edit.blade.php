...
@section('content')
    ...
    <form method="post" action="{{ route('admin.events.update', $event) }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            value="{{ old('title') ?? $event->title }}" aria-describedby="titleHelp">
        ...
        <div class="form-group">
            ...
            aria-describedby="contentHelp">{{ old('content') ?? $event->content }}</textarea>
        ...
        <div class="form-group">
            ...
            value="{{ old('venue') ?? $event->venue }}" aria-describedby="venueHelp">
        ...
        <div class="form-group">
            ...
            value="{{ old('when') ?? $event->when }}" aria-describedby="whenHelp">
